    ...
    <div className="flex flex-grow flex-col bg-white border-t border-b sm:rounded sm:border shadow overflow-hidden">
      <div className="border-b">
        <div className="flex justify-between pl-6 -mb-px">
          <h3 className="text-blue-800 py-4 font-semi text-xl">Annual Leave</h3>
      ...
      <div className="flex px-2 py-2 -mb-px">
        <div className="flex flex-wrap bg-white overflow-hidden">
          <div className="w-auto mx-3 my-3 border-solid border-grey-light rounded border shadow-sm">
            <div className="bg-grey-200 px-2 py-2 border-solid border-grey-light border-b text-center">
              December 2022
            </div>
            <div className="">
              <table className="w-full">
                ...
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td className="py-3 px-4 hover:bg-blue-100 hover:text-white text-center cursor-pointer">
                    1
                  </td>
                </tr>
                <tr>
                  <td className="py-3 px-4 hover:bg-blue-500 hover:text-white text-center cursor-pointer">
                    2
                  </td>
                  <td className="py-3 px-4 hover:bg-blue-500 hover:text-white text-center cursor-pointer">
                    3
            ...
            <div className="">
              <table className="w-full">
                ...
                <tr>
                  <td></td>
                  <td></td>
                  <td className="py-3 px-4 hover:bg-blue hover:text-white text-center cursor-pointer">
                    1
                  </td>
                  <td className="py-3 px-4 hover:bg-blue hover:text-white text-center cursor-pointer">
                    2
